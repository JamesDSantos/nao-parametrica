...
$$P(X=x)=p^x(1-p)^{1-x}=\left[\frac{p}{1-p}\right]^x(1-p)=\eta^x\left[\frac{\eta}{1+\eta}\right]$$
...
$$P(X=x,Y=y)=\left[\frac{\eta_1}{\eta_2}\right]^{x-y}\frac{\eta_1\eta_2}{[1+\eta_1][1+\eta_2]}$$
Deste modo, a estatística $X-Y$ é suficiente para a razão $\eta_1/\eta_2$. A razão de chances (*odds ratio*) é dada por
$$\phi=\frac{\eta_1}{\eta_2}$$
e, se $\phi=1$, $X$ e $Y$ são identicamente distribuídos. Se $\phi>1$, então $\eta_1>\eta_2$, então as chances de $X$ são maiores que as de $Y$.
